export const menuItems = [
  {
    ...
    path: '/du-lich/du-lich-nuoc-ngoai',
    type: 'du-lich-nuoc-ngoai',
    subItems: [
      {
        title: 'Châu Âu',
        path: '/du-lich/du-lich-nuoc-ngoai/chau-au',
        subSubItems: [
          { title: 'Bỉ', path: '/du-lich/du-lich-nuoc-ngoai/chau-au/bi' },
          { title: 'Pháp', path: '/du-lich/du-lich-nuoc-ngoai/chau-au/phap' },
      ...
      {
        title: 'Châu Á',
        path: '/du-lich/du-lich-nuoc-ngoai/chau-a',
        subSubItems: [
          { title: 'Nhật Bản', path: '/du-lich/du-lich-nuoc-ngoai/chau-a/nhat-ban' },
          { title: 'Trung Quốc', path: '/du-lich/du-lich-nuoc-ngoai/chau-a/trung-quoc' },
      ...
      {
        title: 'Châu Mỹ',
        path: '/du-lich/du-lich-nuoc-ngoai/chau-my',
        subSubItems: [
      ...
      {
        title: 'Châu Phi',
        path: '/du-lich/du-lich-nuoc-ngoai/chau-phi',
        subSubItems: [
          { title: 'Ai Cập', path: '/du-lich/du-lich-nuoc-ngoai/chau-phi/ai-cap' },
  ...
  },
  {
    ...
    path: '/du-lich/du-lich-trong-nuoc',
    type: 'du-lich-trong-nuoc',

    subItems: [
      {
        title: 'Miền Trung',
        path: '/du-lich/du-lich-trong-nuoc/mien-trung',
        subSubItems: [
          { title: 'Huế', path: '/du-lich/du-lich-trong-nuoc/mien-trung/hue' },
          { title: 'Đà Nẵng', path: '/du-lich/du-lich-trong-nuoc/mien-trung/da-nang' },
      ...
      {
        title: 'Miền Bắc',
        path: '/du-lich/du-lich-trong-nuoc/mien-bac',
        subSubItems: [
          { title: 'Hà Nội', path: '/du-lich/du-lich-trong-nuoc/mien-bac/ha-noi' },
          { title: 'Hạ Long', path: '/du-lich/du-lich-trong-nuoc/mien-bac/ha-long' },
      ...
      {
        title: 'Miền Nam',
        path: '/du-lich/du-lich-trong-nuoc/mien-nam',
        subSubItems: [
