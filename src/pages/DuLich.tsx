    ...
    <div>
      ...
      <Section>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-x-10'>
          <div className={`fixed col-span-1 md:static inset-0 top-0 left-0 ${showFilter ? "opacity-100 visible z-[423]" : 'opacity-0 invisible md:opacity-100 md:visible z-0'} transition-all bg-white   px-4 md:px-0`}>
            <div className='flex flex-col '>
              {/* <AccodionFilter headerClassName='font-bold text-lg  text-[#013879]' title={t('travel.filter')}>
                
              </AccodionFilter> */}
              <p className='font-bold text-lg  text-[#013879] mb-4 pt-4 '>
                {t('travel.filter')}
              </p>
              <button className='absolute top-4 right-4 mb-4' onClick={() => setShowFilter(!showFilter)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>

              </button>
              <div className='mb-4 grid grid-cols-2 md:grid-cols-1 gap-y-1 md:col-span-2'>
              ...
              <div className='pb-4 md:pb-6 border-b mb-4 grid grid-cols-2 gap-x-2 md:flex md:flex-col md:col-span-2'>
                <div className='mb-4 '>
              ...
              <AccodionFilter title={t('travel.filterOptions.duration')} className='md:col-span-2'>
                <Link
                  state={location.state}
              ...
              <AccodionFilter title={t('travel.filterOptions.people')} className='md:col-span-2'>
                <Link
                  state={location.state}
